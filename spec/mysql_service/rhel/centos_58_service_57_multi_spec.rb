...
describe 'mysql_service_test::single on centos-5.8' do
  cached(:centos_58_service_57_multi) do
  ...
  context 'stepping into mysql_service[default] resource' do
    it 'stops service[default :delete mysql-default]' do
      expect(centos_58_service_57_multi).to_not disable_service('default :delete mysql-default')
      expect(centos_58_service_57_multi).to_not stop_service('default :delete mysql-default')
    end

    it 'deletes directory[default :delete /etc/mysql-default]' do
      expect(centos_58_service_57_multi).to delete_directory('default :delete /etc/mysql-default')
    end

    it 'deletes directory[default :delete /var/run/mysql-default]' do
      expect(centos_58_service_57_multi).to delete_directory('default :delete /var/run/mysql-default')
    end

    it 'deletes directory[default :delete /var/log/mysql-default]' do
      expect(centos_58_service_57_multi).to delete_directory('default :delete /var/log/mysql-default')
    end
  end
  ...
  context 'stepping into mysql_service[instance-1] resource' do
    ...
    it 'stops service[instance-1 :create mysql]' do
      expect(centos_58_service_57_multi).to disable_service('instance-1 :create mysqld')
      expect(centos_58_service_57_multi).to stop_service('instance-1 :create mysqld')
    end
    ...
    it 'creates link[instance-1 :create /usr/share/my-default.cnf]' do
      expect(centos_58_service_57_multi).to create_link('instance-1 :create /usr/share/my-default.cnf')
        .with(
  ...
  context 'stepping into mysql_service[instance-2] resource' do
    ...
    it 'stops service[instance-2 :create mysql]' do
      expect(centos_58_service_57_multi).to disable_service('instance-2 :create mysqld')
      expect(centos_58_service_57_multi).to stop_service('instance-2 :create mysqld')
    end
    ...
    it 'creates link[instance-2 :create /usr/share/my-default.cnf]' do
      expect(centos_58_service_57_multi).to create_link('instance-2 :create /usr/share/my-default.cnf')
        .with(
          target_file: '/usr/share/my-default.cnf',
