...
describe 'mysql_service_test::single on centos-7.0' do
  cached(:centos_70_service_55_multi) do
  ...
  context 'stepping into mysql_service[default] resource' do
    it 'stops service[default :delete mysql-default]' do
      expect(centos_70_service_55_multi).to_not disable_service('default :delete mysql-default')
      expect(centos_70_service_55_multi).to_not stop_service('default :delete mysql-default')
    end

    it 'deletes directory[default :delete /etc/mysql-default]' do
      expect(centos_70_service_55_multi).to delete_directory('default :delete /etc/mysql-default')
    end

    it 'deletes directory[default :delete /var/run/mysql-default]' do
      expect(centos_70_service_55_multi).to delete_directory('default :delete /var/run/mysql-default')
    end

    it 'deletes directory[default :delete /var/log/mysql-default]' do
      expect(centos_70_service_55_multi).to delete_directory('default :delete /var/log/mysql-default')
    end
  end
  ...
  context 'stepping into mysql_service[instance-1] resource' do
    ...
    it 'stops service[instance-1 :create mysql]' do
      expect(centos_70_service_55_multi).to disable_service('instance-1 :create mysql')
      expect(centos_70_service_55_multi).to stop_service('instance-1 :create mysql')
    end
    ...
    it 'creates link[instance-1 :create /usr/share/my-default.cnf]' do
      expect(centos_70_service_55_multi).to create_link('instance-1 :create /usr/share/my-default.cnf')
        .with(
    ...
    it 'create template[instance-1 :start /usr/libexec/mysql-instance-1-wait-ready]' do
      expect(centos_70_service_55_multi).to create_template('instance-1 :start /usr/libexec/mysql-instance-1-wait-ready')
        .with(
    ...
    it 'create template[instance-1 :start /usr/lib/systemd/system/mysql-instance-1.service]' do
      expect(centos_70_service_55_multi).to create_template('instance-1 :start /usr/lib/systemd/system/mysql-instance-1.service')
        .with(
    ...
    it 'create template[instance-1 :start /usr/lib/tmpfiles.d/mysql-instance-1.conf]' do
      expect(centos_70_service_55_multi).to create_template('instance-1 :start /usr/lib/tmpfiles.d/mysql-instance-1.conf')
        .with(
  ...
  context 'stepping into mysql_service[instance-2] resource' do
    ...
    it 'stops service[instance-2 :create mysql]' do
      expect(centos_70_service_55_multi).to disable_service('instance-2 :create mysql')
      expect(centos_70_service_55_multi).to stop_service('instance-2 :create mysql')
    end
    ...
    it 'creates link[instance-2 :create /usr/share/my-default.cnf]' do
      expect(centos_70_service_55_multi).to create_link('instance-2 :create /usr/share/my-default.cnf')
        .with(
          target_file: '/usr/share/my-default.cnf',
    ...
    it 'create template[instance-2 :start /usr/libexec/mysql-instance-2-wait-ready]' do
      expect(centos_70_service_55_multi).to create_template('instance-2 :start /usr/libexec/mysql-instance-2-wait-ready')
        .with(
    ...
    it 'create template[instance-2 :start /usr/lib/systemd/system/mysql-instance-2.service]' do
      expect(centos_70_service_55_multi).to create_template('instance-2 :start /usr/lib/systemd/system/mysql-instance-2.service')
        .with(
    ...
    it 'create template[instance-2 :start /usr/lib/tmpfiles.d/mysql-instance-2.conf]' do
      expect(centos_70_service_55_multi).to create_template('instance-2 :start /usr/lib/tmpfiles.d/mysql-instance-2.conf')
        .with(
