...
describe 'mysql_service_test::single on centos-5.8' do
  cached(:centos_58_service_56_single) do
  ...
  context 'stepping into mysql_service[default] resource' do
    ...
    it 'stops service[default :create mysqld]' do
      expect(centos_58_service_56_single).to disable_service('default :create mysqld')
      expect(centos_58_service_56_single).to stop_service('default :create mysqld')
    end
    ...
    it 'creates link[default :create /usr/share/my-default.cnf]' do
      expect(centos_58_service_56_single).to create_link('default :create /usr/share/my-default.cnf')
        .with(
