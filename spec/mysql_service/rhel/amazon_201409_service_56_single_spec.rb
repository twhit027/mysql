...
describe 'mysql_service_test::single on amazon-2014.09' do
  cached(:amazon_201409_service_56_single) do
  ...
  context 'stepping into mysql_service[default] resource' do
    ...
    it 'stops service[default :create mysqld]' do
      expect(amazon_201409_service_56_single).to disable_service('default :create mysqld')
      expect(amazon_201409_service_56_single).to stop_service('default :create mysqld')
    end
    ...
    it 'creates link[default :create /usr/share/my-default.cnf]' do
      expect(amazon_201409_service_56_single).to create_link('default :create /usr/share/my-default.cnf')
        .with(
