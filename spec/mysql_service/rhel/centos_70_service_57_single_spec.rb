...
describe 'mysql_service_test::single on centos-7.0' do
  ...
  context 'stepping into mysql_service[default] resource' do
    ...
    it 'stops service[default :create mysql]' do
      expect(centos_70_service_57_single).to disable_service('default :create mysql')
      expect(centos_70_service_57_single).to stop_service('default :create mysql')
    end
    ...
    it 'creates link[default :create /usr/share/my-default.cnf]' do
      expect(centos_70_service_57_single).to create_link('default :create /usr/share/my-default.cnf')
        .with(
    ...
    it 'create template[default :start /usr/libexec/mysql-default-wait-ready]' do
      expect(centos_70_service_57_single).to create_template('default :start /usr/libexec/mysql-default-wait-ready')
        .with(
    ...
    it 'create template[default :start /usr/lib/systemd/system/mysql-default.service]' do
      expect(centos_70_service_57_single).to create_template('default :start /usr/lib/systemd/system/mysql-default.service')
        .with(
    ...
    it 'create template[default :start /usr/lib/tmpfiles.d/mysql-default.conf]' do
      expect(centos_70_service_57_single).to create_template('default :start /usr/lib/tmpfiles.d/mysql-default.conf')
        .with(
