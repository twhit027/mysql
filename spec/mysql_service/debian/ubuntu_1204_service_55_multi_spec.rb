...
describe 'mysql_service_test::single on ubuntu-12.04' do
  ...
  context 'compiling the test recipe' do
    it 'creates user[alice]' do
      expect(ubuntu_1204_service_55_multi).to create_user('alice')
    end

    it 'creates group[alice]' do
      expect(ubuntu_1204_service_55_multi).to create_group('alice')
    end

    it 'creates user[bob]' do
      expect(ubuntu_1204_service_55_multi).to create_user('bob')
    end

    it 'creates group[bob]' do
      expect(ubuntu_1204_service_55_multi).to create_group('bob')
    end

    it 'deletes mysql_service[default]' do
      expect(ubuntu_1204_service_55_multi).to delete_mysql_service('default')
    end

    it 'creates mysql_service[instance-1]' do
      expect(ubuntu_1204_service_55_multi).to create_mysql_service('instance-1')
    end

    it 'creates mysql_service[instance-2]' do
      expect(ubuntu_1204_service_55_multi).to create_mysql_service('instance-2')
    end
  end
  ...
  context 'stepping into mysql_service[default] resource' do
    it 'stops service[default :delete mysql-default]' do
      expect(ubuntu_1204_service_55_multi).to_not disable_service('default :delete mysql-default')
      expect(ubuntu_1204_service_55_multi).to_not stop_service('default :delete mysql-default')
    end

    it 'deletes directory[default :delete /etc/mysql-default]' do
      expect(ubuntu_1204_service_55_multi).to delete_directory('default :delete /etc/mysql-default')
    end

    it 'deletes directory[default :delete /run/mysql-default]' do
      expect(ubuntu_1204_service_55_multi).to delete_directory('default :delete /run/mysql-default')
    end

    it 'deletes directory[default :delete /var/log/mysql-default]' do
      expect(ubuntu_1204_service_55_multi).to delete_directory('default :delete /var/log/mysql-default')
    end
  end
  ...
  context 'stepping into mysql_service[instance-1] resource' do
    it 'installs package[instance-1 :create mysql-server-5.5]' do
      expect(ubuntu_1204_service_55_multi).to install_package('instance-1 :create mysql-server-5.5')
        .with(package_name: 'mysql-server-5.5', version: nil)
    end

    it 'stops service[instance-1 :create mysql]' do
      expect(ubuntu_1204_service_55_multi).to disable_service('instance-1 :create mysql')
      expect(ubuntu_1204_service_55_multi).to stop_service('instance-1 :create mysql')
    end

    it 'installs package[instance-1 :create apparmor]' do
      expect(ubuntu_1204_service_55_multi).to install_package('instance-1 :create apparmor')
        .with(package_name: 'apparmor', version: nil)
    end

    it 'creates directory[instance-1 :create /etc/apparmor.d/local/mysql]' do
      expect(ubuntu_1204_service_55_multi).to create_directory('instance-1 :create /etc/apparmor.d/local/mysql')
        .with(
    ...
    it 'creates template[instance-1 :create /etc/apparmor.d/local/usr.sbin.mysqld]' do
      expect(ubuntu_1204_service_55_multi).to create_template('instance-1 :create /etc/apparmor.d/local/usr.sbin.mysqld')
        .with(
    ...
    it 'creates template[instance-1 :create /etc/apparmor.d/usr.sbin.mysqld]' do
      expect(ubuntu_1204_service_55_multi).to create_template('instance-1 :create /etc/apparmor.d/usr.sbin.mysqld')
        .with(
    ...
    it 'creates template[instance-1 :create /etc/apparmor.d/local/mysql/instance-1]' do
      expect(ubuntu_1204_service_55_multi).to create_template('instance-1 :create /etc/apparmor.d/local/mysql/instance-1')
        .with(
    ...
    it 'creates service[instance-1 :create apparmor]' do
      expect(ubuntu_1204_service_55_multi).to_not start_service('instance-1 :create apparmor').with(
        service_name: 'apparmor'
        )
    end

    it 'creates group[instance-1 :create mysql]' do
      expect(ubuntu_1204_service_55_multi).to create_group('instance-1 :create mysql')
        .with(group_name: 'mysql')
    end

    it 'creates user[instance-1 :create mysql]' do
      expect(ubuntu_1204_service_55_multi).to create_user('instance-1 :create mysql')
        .with(username: 'mysql')
    end

    it 'deletes file[instance-1 :create /etc/mysql/my.cnf]' do
      expect(ubuntu_1204_service_55_multi).to delete_file('instance-1 :create /etc/mysql/my.cnf')
        .with(path: '/etc/mysql/my.cnf')
    end

    it 'deletes file[instance-1 :create /etc/my.cnf]' do
      expect(ubuntu_1204_service_55_multi).to delete_file('instance-1 :create /etc/my.cnf')
        .with(path: '/etc/my.cnf')
    end

    it 'creates link[instance-1 :create /usr/share/my-default.cnf]' do
      expect(ubuntu_1204_service_55_multi).to create_link('instance-1 :create /usr/share/my-default.cnf')
        .with(
    ...
    it 'creates directory[instance-1 :create /etc/mysql-instance-1]' do
      expect(ubuntu_1204_service_55_multi).to create_directory('instance-1 :create /etc/mysql-instance-1')
        .with(
    ...
    it 'creates directory[instance-1 :create /etc/mysql-instance-1/conf.d]' do
      expect(ubuntu_1204_service_55_multi).to create_directory('instance-1 :create /etc/mysql-instance-1/conf.d')
        .with(
    ...
    it 'creates directory[instance-1 :create /run/mysql-instance-1]' do
      expect(ubuntu_1204_service_55_multi).to create_directory('instance-1 :create /run/mysql-instance-1')
        .with(
    ...
    it 'creates directory[instance-1 :create /var/log/mysql-instance-1]' do
      expect(ubuntu_1204_service_55_multi).to create_directory('instance-1 :create /var/log/mysql-instance-1')
        .with(
    ...
    it 'creates directory[instance-1 :create /data/instance-1]' do
      expect(ubuntu_1204_service_55_multi).to create_directory('instance-1 :create /data/instance-1')
        .with(
    ...
    it 'creates template[instance-1 :create /etc/mysql-instance-1/my.cnf]' do
      expect(ubuntu_1204_service_55_multi).to create_template('instance-1 :create /etc/mysql-instance-1/my.cnf')
        .with(
    ...
    it 'runs bash[instance-1 :create initialize mysql database]' do
      expect(ubuntu_1204_service_55_multi).to_not run_bash('instance-1 :create initialize mysql database')
        .with(
          cwd: '/data/instance-1'
        )
    end
    ...
    it 'starts service[instance-1 :start mysql-instance-1]' do
      expect(ubuntu_1204_service_55_multi).to start_service('instance-1 :start mysql-instance-1')
        .with(
  ...
  context 'stepping into mysql_service[instance-2] resource' do
    it 'installs package[instance-2 :create mysql-server-5.5]' do
      expect(ubuntu_1204_service_55_multi).to install_package('instance-2 :create mysql-server-5.5')
        .with(package_name: 'mysql-server-5.5', version: nil)
    end

    it 'stops service[instance-2 :create mysql]' do
      expect(ubuntu_1204_service_55_multi).to disable_service('instance-2 :create mysql')
      expect(ubuntu_1204_service_55_multi).to stop_service('instance-2 :create mysql')
    end

    it 'installs package[instance-2 :create apparmor]' do
      expect(ubuntu_1204_service_55_multi).to install_package('instance-2 :create apparmor')
        .with(package_name: 'apparmor', version: nil)
    end

    it 'creates directory[instance-2 :create /etc/apparmor.d/local/mysql]' do
      expect(ubuntu_1204_service_55_multi).to create_directory('instance-2 :create /etc/apparmor.d/local/mysql')
        .with(
          path: '/etc/apparmor.d/local/mysql',
          owner: 'root',
          group: 'root',
    ...
    it 'creates template[instance-2 :create /etc/apparmor.d/local/usr.sbin.mysqld]' do
      expect(ubuntu_1204_service_55_multi).to create_template('instance-2 :create /etc/apparmor.d/local/usr.sbin.mysqld')
        .with(
          path: '/etc/apparmor.d/local/usr.sbin.mysqld',
          cookbook: 'mysql',
          source: 'apparmor/usr.sbin.mysqld-local.erb',
    ...
    it 'creates template[instance-2 :create /etc/apparmor.d/usr.sbin.mysqld]' do
      expect(ubuntu_1204_service_55_multi).to create_template('instance-2 :create /etc/apparmor.d/usr.sbin.mysqld')
        .with(
          path: '/etc/apparmor.d/usr.sbin.mysqld',
          cookbook: 'mysql',
          source: 'apparmor/usr.sbin.mysqld.erb',
    ...
    it 'creates template[instance-2 :create /etc/apparmor.d/local/mysql/instance-2]' do
      expect(ubuntu_1204_service_55_multi).to create_template('instance-2 :create /etc/apparmor.d/local/mysql/instance-2')
        .with(
    ...
    it 'creates service[instance-2 :create apparmor]' do
      expect(ubuntu_1204_service_55_multi).to_not start_service('instance-2 :create apparmor').with(
        service_name: 'apparmor'
        )
    end

    it 'creates group[instance-2 :create mysql]' do
      expect(ubuntu_1204_service_55_multi).to create_group('instance-2 :create mysql')
        .with(group_name: 'mysql')
    end

    it 'creates user[instance-2 :create mysql]' do
      expect(ubuntu_1204_service_55_multi).to create_user('instance-2 :create mysql')
        .with(username: 'mysql')
    end

    it 'deletes file[instance-2 :create /etc/mysql/my.cnf]' do
      expect(ubuntu_1204_service_55_multi).to delete_file('instance-2 :create /etc/mysql/my.cnf')
        .with(path: '/etc/mysql/my.cnf')
    end

    it 'deletes file[instance-2 :create /etc/my.cnf]' do
      expect(ubuntu_1204_service_55_multi).to delete_file('instance-2 :create /etc/my.cnf')
        .with(path: '/etc/my.cnf')
    end

    it 'creates link[instance-2 :create /usr/share/my-default.cnf]' do
      expect(ubuntu_1204_service_55_multi).to create_link('instance-2 :create /usr/share/my-default.cnf')
        .with(
          target_file: '/usr/share/my-default.cnf',
    ...
    it 'creates directory[instance-2 :create /etc/mysql-instance-2]' do
      expect(ubuntu_1204_service_55_multi).to create_directory('instance-2 :create /etc/mysql-instance-2')
        .with(
    ...
    it 'creates directory[instance-2 :create /etc/mysql-instance-2/conf.d]' do
      expect(ubuntu_1204_service_55_multi).to create_directory('instance-2 :create /etc/mysql-instance-2/conf.d')
        .with(
    ...
    it 'creates directory[instance-2 :create /run/mysql-instance-2]' do
      expect(ubuntu_1204_service_55_multi).to create_directory('instance-2 :create /run/mysql-instance-2')
        .with(
    ...
    it 'creates directory[instance-2 :create /var/log/mysql-instance-2]' do
      expect(ubuntu_1204_service_55_multi).to create_directory('instance-2 :create /var/log/mysql-instance-2')
        .with(
    ...
    it 'creates directory[instance-2 :create /data/instance-2]' do
      expect(ubuntu_1204_service_55_multi).to create_directory('instance-2 :create /data/instance-2')
        .with(
    ...
    it 'creates template[instance-2 :create /etc/mysql-instance-2/my.cnf]' do
      expect(ubuntu_1204_service_55_multi).to create_template('instance-2 :create /etc/mysql-instance-2/my.cnf')
        .with(
    ...
    it 'runs bash[instance-2 :create initialize mysql database]' do
      expect(ubuntu_1204_service_55_multi).to_not run_bash('instance-2 :create initialize mysql database')
        .with(
          cwd: '/data/instance-2'
        )
    end
    ...
    it 'creates template[instance-2 :create /etc/init/mysql-instance-2.conf]' do
      expect(ubuntu_1204_service_55_multi).to create_template('instance-2 :start /etc/init/mysql-instance-2.conf')
        .with(
    ...
    it 'starts service[instance-2 :start mysql-instance-2]' do
      expect(ubuntu_1204_service_55_multi).to start_service('instance-2 :start mysql-instance-2')
        .with(
